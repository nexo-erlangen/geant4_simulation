...
// ================ DIMENSIONS ================
    ...
    G4double SiPM_Height_Above_Source = 3.22*cm;
  
    G4double SiPM_Frame_xy = 0.505*cm; //total xy-length
    G4double SiPM_Frame_z = 0.18*cm;//total thickness
    
    G4double SiPM_Sensitive_xy = 0.36*cm;
    G4double SiPM_Sensitive_z = 0.1*cm;
...
// SiPM Board
    ...
    G4double SiPM_Board_Thickness = 0.18*cm;// Total values!
