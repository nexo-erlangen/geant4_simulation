...
public: // methods, with descriptions
	...
	void SetSinglePhaseBoolean(const G4bool boolean);
	
        G4bool GetSinglePhaseBoolean() const;
	
	G4double GetYieldReductionFactor() const;
	void SetYieldReductionFactor(const G4double factor);
...
inline
void G4S1Light::SetSinglePhaseBoolean(const G4bool boolean)
{
	SinglePhase = boolean;
}

inline
G4bool G4S1Light::GetSinglePhaseBoolean() const
{return SinglePhase;}

inline
G4double G4S1Light::GetYieldReductionFactor() const
{return YieldReductionFactor;}

inline
void G4S1Light::SetYieldReductionFactor(const G4double factor)
{YieldReductionFactor = factor;}
